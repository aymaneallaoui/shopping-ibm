...
const CartItem = ({ onContinueShopping }) => {
  ...
  // Convert cost string to number for calculation
  const calculateTotalCost = (item) => {
    const itemCost = Number(item.cost.replace('$', '')); // Remove $ and convert to number
    return (itemCost * item.quantity);
  };

  let totalCost = 0;

  totalCost = cart.reduce((total, item) => total + calculateTotalCost(item), 0);
